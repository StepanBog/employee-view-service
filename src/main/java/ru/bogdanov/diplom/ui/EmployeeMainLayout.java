...
public class EmployeeMainLayout extends FlexBoxLayout implements RouterLayout, AfterNavigationObserver {

    private static final Logger log = LoggerFactory.getLogger(EmployeeMainLayout.class);
    ...
    private void initNaviItems() {
        ...
        menu.addNaviItem(VaadinIcon.HOME, "Home", EmployeeView.class);
    }
   ...
   /* private void setAppFooterInner(Component... components) {
    ...
    public static EmployeeMainLayout get() {
        return (EmployeeMainLayout) UI.getCurrent().getChildren()
                .filter(component -> component.getClass() == EmployeeMainLayout.class)
                .findFirst().get();
    }
